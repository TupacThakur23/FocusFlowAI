...
const UserFeedbackSystem = ({ 
  ...
  const severityLevels = {
    ...
    high: { label: 'High', color: 'orange', description: 'Significant impact on functionality' },
  ...
  const satisfactionPrompts = [
    ...
    { id: 'research_session', trigger: 'session_end', delay: 0, question: 'How was your research session?' },
          ...
          <div className="rating-buttons">
            {[1, 2, 3, 4, 5].map(star => (
              <button
                ...
                className={`rating-btn ${star <= rating ? 'active' : ''}`}
              >
              ...
              <div className="modal-tabs">
                {Object.entries(feedbackCategories).map(([key, category]) => (
                  <button
                    ...
                    className={`tab-btn ${feedbackType === key ? 'active' : ''}`}
                  >
                    {category.icon}
                ...
                <div className="form-section">
                  <label className="form-label">
                    ...
                    >
                      ...
                      {feedbackCategories[feedbackType].subcategories.map(sub => (
  ...
  const renderQuickFeedback = () => (
    <div className="quick-feedback">
      ...
      <div className="quick-feedback-options">
        <button
          onClick={() => handleQuickFeedback('helpful', true)}
        ...
        <button
          onClick={() => handleQuickFeedback('helpful', false)}
        ...
        <button
          onClick={() => handleQuickFeedback('confused', true)}
          className="quick-btn neutral"
        >
        ...
        <button
          onClick={() => handleQuickFeedback('love', true)}
          className="quick-btn positive"
        >
    ...
    return (
      <div className="feedback-history">
        <div className="history-header">
          ...
          >
            {expandedCategories.has('history') ? (
        ...
        {expandedCategories.has('history') && (
          <div className="history-list">
            {feedbackHistory.slice(-5).map((feedback, index) => (
  ...
  return (
    <div className={`user-feedback-system ${className}`}>

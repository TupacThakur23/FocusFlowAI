...
import { ChevronRight, ChevronLeft, X, Check, Play, Pause, ArrowRight, BookOpen, Brain, Shield, Zap, Target, Lightbulb, Settings, Globe, Lock, Eye, EyeOff, Sparkles, ArrowRightCircle } from 'lucide-react';
...
const OnboardingExperience = ({
  ...
  const [onboardingState, setOnboardingState] = useExtensionState('onboarding', {
    storage: 'local'
  });
  const [permissions] = useExtensionState('permissions', {
    storage: 'local'
  });
  const {
    addToast
  ...
  const onboardingSteps = [{
    ...
    type: 'value_prop',
    features: ['Semantic understanding of your research context', 'Continuity across browsing sessions', 'Intelligent suggestions without distraction']
  }, {
    id: 'permissions',
    ...
    permissions: [{
      ...
      reason: 'To understand your research context',
      required: true
    }, {
      name: 'Access browsing history',
      reason: 'To provide research continuity',
      required: false
    }, {
      name: 'Store data locally',
      reason: 'To remember your research progress',
      required: true
    }]
  }, {
    id: 'key_features',
    ...
    features: [{
      ...
      description: 'AI-enhanced note-taking with contextual understanding'
    }, {
      icon: <Target className="w-5 h-5" />,
      title: 'Smart Retrieval',
      description: 'Find relevant information across your research'
    }, {
      icon: <Lightbulb className="w-5 h-5" />,
      title: 'Intelligent Suggestions',
      description: 'Contextual recommendations without distraction'
    }]
  }, {
    id: 'interactive_demo',
    title: 'Try It Now',
    ...
    templates: [{
      ...
      description: 'For work-related research',
      icon: '💼'
    }, {
      id: 'personal',
      title: 'Personal Learning',
      description: 'For self-directed learning',
      icon: '🌱'
    }, {
      id: 'custom',
      title: 'Custom Setup',
    ...
    type: 'completion',
    next_steps: ['Start researching on any webpage', 'Use the sidebar to access your notebooks', 'Check settings to customize your experience']
  }];
  useEffect(() => {
  ...
  const renderWelcomeStep = step => <div className="onboarding-welcome">
  ...
  const renderValuePropStep = step => <div className="onboarding-value-prop">
      ...
      <div className="value-content">
        ...
        <div className="value-features">
          {step.features.map((feature, index) => <div key={index} className="value-feature">
  ...
  const renderPermissionsStep = step => <div className="onboarding-permissions">
      ...
      <div className="permissions-content">
        ...
        <div className="permissions-list">
          {step.permissions.map((permission, index) => <div key={index} className="permission-item">
              ...
              <div className="permission-toggle">
                <button onClick={() => handlePermissionToggle(permission.name, true)} className={`toggle-btn ${permissions?.[permission.name] ? 'active' : ''}`}>
  ...
  const renderFeaturesStep = step => <div className="onboarding-features">
      ...
      <div className="features-content">
        ...
        <div className="features-grid">
          {step.features.map((feature, index) => <div key={index} className="feature-card">
  ...
  const renderDemoStep = step => <div className="onboarding-demo">
        ...
        <div className="demo-interface">
          <div className="demo-header">
            ...
            <div className="demo-status">
              {interactiveDemo === 'active' ? <><div className="status-dot active"></div> Demo Active</> : interactiveDemo === 'completed' ? <><Check className="w-4 h-4 text-green-500" /> Demo Complete</> : <><div className="status-dot"></div> Ready to Start</>}
            </div>
          </div>

          <div className="demo-body">
            <div className="demo-input">
              <input type="text" placeholder={step.demo.placeholder} className="demo-text-input" readOnly={interactiveDemo === 'active'} />
              <button onClick={handleDemoStart} className={`demo-btn ${interactiveDemo ? 'disabled' : ''}`} disabled={interactiveDemo}>
                {interactiveDemo === 'active' ? <><Pause className="w-4 h-4" /> Running...</> : <><Play className="w-4 h-4" /> Start Demo</>}
              </button>
            </div>

            {interactiveDemo === 'active' && <div className="demo-response">
            ...
            {interactiveDemo === 'completed' && <div className="demo-response completed">
  ...
  const renderTemplatesStep = step => <div className="onboarding-templates">
      ...
      <div className="templates-content">
        ...
        <div className="templates-grid">
          {step.templates.map(template => <div key={template.id} className={`template-card ${selectedTemplate === template.id ? 'selected' : ''}`} onClick={() => handleTemplateSelect(template.id)}>
              <div className="template-icon">{template.icon}</div>
              <div className="template-content">
                <h4 className="template-title">{template.title}</h4>
                <p className="template-description">{template.description}</p>
              </div>
              {selectedTemplate === template.id && <div className="template-selected">
  ...
  const renderCompletionStep = step => <div className="onboarding-completion">
      ...
      <div className="completion-content">
        ...
        <div className="next-steps">
          <h4>Next Steps:</h4>
          <ul>
            {step.next_steps.map((nextStep, index) => <li key={index}>
  ...
  return <div className={`onboarding-experience ${className}`}>
      <div className="onboarding-overlay">
        <div className="onboarding-modal">
          ...
          <div className="onboarding-header">
            ...
            <button onClick={handleSkip} className="skip-btn" title="Skip onboarding">
              <X className="w-4 h-4" />
            </button>
          </div>
          ...
          <div className="onboarding-navigation">
            <button onClick={handlePrevious} disabled={currentStep === 0} className="nav-btn prev">
              <ChevronLeft className="w-4 h-4" />
              Previous
            </button>

            <div className="step-dots">
              {onboardingSteps.map((_, index) => <div key={index} className={`dot ${index === currentStep ? 'active' : ''}`} />)}
            </div>

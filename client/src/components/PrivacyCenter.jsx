...
const PrivacyCenter = ({ 
  ...
  const [consentStatus, setConsentStatus] = useExtensionState('consentStatus', { storage: 'local' });
  ...
  const privacyTabs = [
    ...
    { id: 'controls', label: 'Privacy Controls', icon: <Settings className="w-4 h-4" /> },
    { id: 'transparency', label: 'AI Transparency', icon: <Brain className="w-4 h-4" /> },
  ...
  const handleConsentUpdate = useCallback((consentType, granted) => {
    const newConsent = { ...consentStatus, [consentType]: { granted, timestamp: Date.now() } };
    ...
    <div className="data-usage">
      ...
      <div className="data-categories">
        <div className="category-item">
          ...
          {expandedSections.has('research-data') && (
        ...
        <div className="category-item">
          ...
          {expandedSections.has('session-data') && (
            <div className="category-details">
              <div className="detail-item">
                <span className="detail-label">Storage Location:</span>
          ...
          <div className="control-items">
            ...
            <div className="control-item">
              ...
              <label className="toggle-switch">
                <input
                  type="checkbox"
                  checked={privacySettings?.localProcessing || false}
          ...
          <div className="control-items">
            <div className="control-item">
              ...
              <label className="toggle-switch">
                <input
                  type="checkbox"
                  checked={privacySettings?.aiAssistance || false}
            ...
            <div className="control-item">
              ...
              <label className="toggle-switch">
                <input
                  type="checkbox"
                  checked={privacySettings?.researchContinuity || false}
                  onChange={(e) => handleSettingChange('researchContinuity', e.target.checked)}
                />
                <span className="toggle-slider"></span>
              </label>
            </div>
            ...
            <div className="control-item">
              ...
              <label className="toggle-switch">
                <input
                  type="checkbox"
                  checked={privacySettings?.semanticSearch || false}
                  onChange={(e) => handleSettingChange('semanticSearch', e.target.checked)}
                />
                <span className="toggle-slider"></span>
              </label>
            </div>
        ...
        <div className="control-section">
          ...
          <div className="control-items">
            <div className="control-item">
              ...
              <select
                value={privacySettings?.dataRetention || 30}
          ...
          <div className="control-items">
            <div className="control-item">
              ...
              <label className="toggle-switch">
                <input
                  type="checkbox"
                  checked={privacySettings?.encryptionEnabled || false}
            ...
            <div className="control-item">
              ...
              <label className="toggle-switch">
                <input
                  type="checkbox"
                  checked={privacySettings?.secureStorage || false}
                  onChange={(e) => handleSettingChange('secureStorage', e.target.checked)}
                />
                <span className="toggle-slider"></span>
              </label>
            </div>
            ...
            <div className="consent-items">
              <div className="consent-item">
                ...
                <div className="consent-status">
                  {consentStatus?.aiProcessing?.granted ? (
                    ...
                    <button 
                      onClick={() => handleConsentUpdate('aiProcessing', true)}
              ...
              <div className="consent-item">
                ...
                <div className="consent-status">
                  {consentStatus?.dataStorage?.granted ? (
                    <span className="status-granted">
                      <CheckCircle className="w-4 h-4" />
                      Granted
                    </span>
                    ...
                    <button 
                      onClick={() => handleConsentUpdate('dataStorage', true)}
                      className="consent-btn"
                    >
                      Grant Consent
                    </button>

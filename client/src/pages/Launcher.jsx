...
export default function Launcher({ onNavigate }) {
  return (
    <div className="w-[320px] bg-[#0a0a0b] text-[#f3f4f6] font-sans flex flex-col overflow-hidden mx-auto border border-[#26272b] rounded-xl shadow-2xl">
      ...
      <div className="px-5 pb-4 flex flex-col gap-3">
        ...
        <button
          onClick={() => {
            // Open Research Hub in a full browser tab

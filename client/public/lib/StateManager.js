export class StateManager {
  ...
  async getStorageKeys(storageArea) {
    const localKeys = ['aideIsCollapsed', 'aideCommand', 'focusflow_settings', 'focusflow_user_preferences', 'aideCurrentTab', 'aideCurrentSelection', 'aideActiveTabId', 'focusflow_temp_data', 'aideExtractedContent'];
    return localKeys;
  }
